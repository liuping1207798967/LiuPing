...
{
    /// <summary>
    /// The TapToPlace class is a basic way to enable users to move objects  and place them on real world surfaces. Put this script on the object you want to be able to move. 
    ...
    public class TapToPlace : MonoBehaviour, IInputClickHandler
    {
        ...
        protected virtual void Update()
        {
            ...
            if (IsBeingPlaced)
            {
                ...
                {
                    // Rotate this object to face the user.旋转物体面对用户。
                    Quaternion toQuat = Camera.main.transform.localRotation;
                    toQuat.x = 0;
                    toQuat.z = 0;

                    // Move this object to where the raycast这个对象移动到raycast的地方
