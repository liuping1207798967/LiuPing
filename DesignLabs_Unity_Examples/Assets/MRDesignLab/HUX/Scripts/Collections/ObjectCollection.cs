...
{
    /// <summary>子对象的对象集合仅是一组有组织的一些布局参数。对象集合可以用来快速创建控制面板或套预制/对象。
    ...
    public class ObjectCollection : MonoBehaviour
    {
        ...
        /// <summary>
        /// Action called when collection is updated行动时调用收集更新
        /// </summary>
        public Action<ObjectCollection> OnCollectionUpdated;

        /// <summary>
        /// List of objects with generated data on the object.对象与生成的数据对象的列表。
        /// </summary>
        [SerializeField]
        ...
        /// <summary>
        /// Should the objects in the collection face the origin of the collection集合中的对象应该面对收集的起源吗
        /// </summary>
        ...
        /// <summary>
        /// Whether to sort objects by row first or by column first是否要先对象第一行或列进行排序
        /// </summary>
        ...
        /// <summary>
        /// This is the radius of either the Cylinder or Sphere mapping and is ignored when using the plane mapping.这是半径的圆柱体或球面映射和使用平面映射时被忽略。
        /// </summary>
        [Range(0.05f, 5.0f)]
        ...
        /// <summary>
        /// Number of rows per column, column number is automatically determined每列的行数,列数是自动确定
        /// </summary>
        ...
        /// <summary>
        /// Update collection is called from the editor button on the inspector. This function rebuilds / updates the layout.更新集合称为巡查员从编辑器按钮。这个函数重建/更新布局。
        /// </summary>
        public void UpdateCollection()
        {
            ...
            // Check when children change and adjust检查当子lei改变和调整
        ...
        /// <summary>
        /// Internal function for laying out all the children when UpdateCollection is called.内部功能布局UpdateCollection叫做时所有的孩子。
        /// </summary>
        private void LayoutChildren() {
            ...
            // First start with a grid then project onto surface先挖一个网格然后项目到表面
            switch (LayoutType)
            {
        ...
        /// <summary>
        /// Internal function for getting the relative mapping based on a source Vec3 and a radius for cylinder mapping.内部函数获得相对映射基于源Vec3和半径圆柱映射。
        /// </summary>
        ...
        /// <summary>
        /// Gizmos to draw when the Collection is selected.当收集被选中。
        /// </summary>
