...
namespace HoloToolkit.Unity.InputModule
{
    ...
    public class TapToPlace_bd : MonoBehaviour, IInputClickHandler
    {
        ...
        private void HandlePlacement()
        {
            if (IsBeingPlaced)
            {
                ...
                //gameObject.GetComponent<HoloRotate>().enabled = false ;
            ...
            else
            {
                ...
                //gameObject.GetComponent<HoloRotate>().enabled = true ;
                butt.transform.SetParent(null);
                butt.SetActive(true);
                butt.transform.position = this.gameObject.transform.position + new Vector3(0.8f, 0.1f, -0.69f);
